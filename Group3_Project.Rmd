...
train1$LotFrontage <- as.integer(train1$LotFrontage)
train1$MasVnrArea <- as.integer(train1$MasVnrArea)
train1$GarageYrBlt <- as.integer(train1$LotFrontage)
train1$SalePrice <- as.integer(train1$MasVnrArea)
