...
```{r nas, warning=FALSE, message=FALSE, echo=FALSE}
...
```{r boost, warning=FALSE, cache=TRUE, echo=FALSE}
...
# Results
|   The predicted Sale Price was submitted to Kaggle and a score of 0.14931 was given. According to the Kaggle competition, this score is calculated by taking the root mean squared error between the logarithm of the predicted value and the logarithm of the observed sales price. This places us at 3074 out of 5396 submissions. However, most of the top 1000 submissions had RMSE scores of about 0.12, which isn't that far off from our score. Overall, we were able to create a fairly accurate model  
