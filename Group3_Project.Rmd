...
```{r boost, warning=FALSE, cache=TRUE}
...
|   Once the test data was properly configured, the Random Forest model was fit using the entire training set and the predcition of SalePrice using the configured test data was made.
