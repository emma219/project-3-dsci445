...
# Methodology 
	...
	A Decision Tree model is first explored as the output is easily interpreted and its graphical representation can be straightforwardly related to the project’s hypothesis. Though the downfalls of Decision Trees are known, such as overfitting. Instead of taking the approach of pre-pruning the Decision Tree using Chi^2 test, which is “an algorithm used to find out the statistical significance between parent and child nodes” (Analytics Vidhya), or post-pruning using error estimation, in order to avoid overfitting and get a better understanding of the significance of the data’s variables, other models were explored, including Random Forest.  
	...
	An AdaBoost Boosting model was also chosen   
